...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Store backend connection status for later use
    window.backendConnected = backendConnected;
...
function initializeGame() {
    ...
    if (gameState.isLoggedIn && gameState.playerId) {
        ...
        // Load game state from backend only if backend is connected
...
function useMockData() {
    ...
    showNotification('Backend not connected - using mock data', 'info');
}
...
const ranks = {
  0: "Investigation Intern",
  3: "Junior Analyst",
  5: "Investigation Officer",
  8: "Crime Analyst",
  11: "Senior Investigator",
  15: "Lead Investigator",
  17: "Special Operations Lead",
  18: "Vritra Task Force Commander"
};